...
/**
 * 
 * 本文采用http://www.eoeandroid.com/thread-114268-1-1.html的代码 使用JPCT-AE 3D框架，实现一个立方体，代码中有具体的说明
 * 
...
public class HelloWorldActivity extends Activity {
	...
	private static HelloWorldActivity master = null;
	// GLSurfaceView对象
		...
		public void onSurfaceChanged(GL10 gl, int w, int h) {
			...
			if (master == null) {
				...
				if (master == null) {
					...
					master = HelloWorldActivity.this;
				}
			}
		}
